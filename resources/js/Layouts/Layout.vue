...
<template>
    <div class="group flex h-trueH w-screen overflow-x-clip bg-[#EEF1F6]" :class="{ 'py-6':navMenuState }" @click.self="toggleMenu">
        ...
        <div class="relative h-full w-screen shrink-0 overflow-y-scroll bg-[#FFFFFF]" :class="{ 'overflow-y-clip rounded-tl-3xl rounded-bl-3xl blur-[0.5px] rounded-xl pointer-events-none':navMenuState }">
            ...
            <div class="mb-6 pt-4 pb-6 space-y-4 w-full sticky top-0 z-10 bg-[#FFFFFF]">
                <div class="flex space-x-4 justify-between items-center px-4">
                    ...
                    <div class="w-12 h-12 shrink-0 rounded-full flex justify-center items-center bg-[#EEF1F6]" @click="toggleMenu">
                    ...
                    <div class="w-full h-full justify-start items-center flex md:hidden">
                    ...
                    <div class="w-full h-12 bg-[#EEF1F6] rounded-full hidden md:flex" :class="{ 'ring-2 ring-black ring-offset-2':filterDrawerState }">
            ...
            <div class="pb-6 flex px-4 md:hidden">
