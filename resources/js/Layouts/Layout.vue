...
<template>
    <div class="group flex h-[--vh] w-screen overflow-x-clip bg-[#EEF1F6] md:py-0" :class="{ 'py-14':navMenuState }" @click.self="toggleMenu">
        <div class="flex h-full shrink-0 items-center justify-end transition-all" :class="{ 'md:w-72 w-60':navMenuState, 'w-0':!navMenuState }" @click.self="toggleMenu">
            <div class="flex w-full flex-col">
                ...
                <Link href="/portfolio" class="border-r-8 border-[#000000] py-4 pl-4 border-opacity-0 opacity-50 hover:opacity-100 text-[#000000] hover:border-opacity-100 font-sans text-2xl md:text-4xl font-bold hover:text-[#000000]" :class="{ 'opacity-100 border-opacity-100 text-[#000000]':$page.component === 'Portfolio'}">
                    Portfolio
                </Link>
            </div>
        </div>
        <div class="relative h-full w-screen shrink-0 overflow-y-scroll bg-[#FFFFFF]" :class="{ 'overflow-y-clip rounded-tl-3xl rounded-bl-3xl blur-[0.5px] rounded-xl pointer-events-none':navMenuState }">

            <div class="mb-6 pt-4 pb-6 space-y-4 w-full sticky top-0 z-10 bg-[#FFFFFF]">
                <div class="flex space-x-4 justify-between items-center px-4">

                    <div class="w-12 h-12 md:w-14 md:h-14 shrink-0 rounded-full flex justify-center items-center bg-[#EEF1F6]" :class="{ 'rotate-90':navMenuState }" @click="toggleMenu">
                    ...
                    <!--                        <svg class="w-full h-full md:w-auto" xmlns="http://www.w3.org/2000/svg" width="189" height="27" viewBox="0 0 189 27" fill="none">-->
                ...
                <div class="w-full h-12 flex overflow-x-scroll snap-start scroll-pl-4 space-x-4 " v-if="filterDrawerState">
                    <div class="rounded-full shrink-0 h-full w-auto bg-[#EEF1F6] flex px-4 justify-center items-center flex-none">
                        <h1 class="font-sans font-light snap-start">Lorem Ipsum</h1>
                    </div>
                    <div class="rounded-full shrink-0 h-full w-auto bg-[#EEF1F6] flex px-4 justify-center items-center flex-none">
                        <h1 class="font-sans font-light snap-start">Lorem Ipsum</h1>
                    </div>
            ...
            <slot :filterDrawerState="filterDrawerState"/>
