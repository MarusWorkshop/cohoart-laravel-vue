<template>
    <Layout>
        <div class="mb-6 flex flex-col p-4 space-y-2 bg-[#FFFFFF]">
            ...
            <div class="grow columns-2 overflow-y-scroll md:columns-3xs" :class="{ 'columns-1' : postFlowSingle, 'columns-2' : !postFlowSingle }">
                ...
                <div class="relative mb-6 rounded-xl space-y-4">
                    <img class="rounded-xl shadow-md" src="https://source.unsplash.com/random/12" />
                    <div class="flex h-6 items-center justify-start space-x-2 md:h-10">
                        <div class="flex h-full w-6 shrink-0 items-center justify-center overflow-hidden rounded-full md:w-10">
                            <img class="h-full w-full object-cover" src="https://source.unsplash.com/random/2" />
                        </div>
                ...
                <div class="relative mb-6 rounded-xl space-y-4">
                    <img class="rounded-xl shadow-md" src="https://source.unsplash.com/random/15" />
                    <div class="flex h-6 items-center justify-start space-x-2 md:h-10">
                        <div class="flex h-full w-6 shrink-0 items-center justify-center overflow-hidden rounded-full md:w-10">
                            <img class="h-full w-full object-cover" src="https://source.unsplash.com/random/2" />
                        </div>
                ...
                <div class="relative mb-6 rounded-xl space-y-4">
                    <img class="rounded-xl shadow-md" src="https://source.unsplash.com/random/16" />
                    <div class="flex h-6 items-center justify-start space-x-2 md:h-10">
                        <div class="flex h-full w-6 shrink-0 items-center justify-center overflow-hidden rounded-full md:w-10">
                            <img class="h-full w-full object-cover" src="https://source.unsplash.com/random/2" />
                        </div>
                ...
                <div class="relative mb-6 rounded-xl space-y-4">
                    <img class="rounded-xl shadow-md" src="https://source.unsplash.com/random/17" />
                    <div class="flex h-6 items-center justify-start space-x-2 md:h-10">
                        <div class="flex h-full w-6 shrink-0 items-center justify-center overflow-hidden rounded-full md:w-10">
                            <img class="h-full w-full object-cover" src="https://source.unsplash.com/random/2" />
                        </div>
                ...
                <div class="relative mb-6 rounded-xl space-y-4">
                    <img class="rounded-xl shadow-md" src="https://source.unsplash.com/random/18" />
                    <div class="flex h-6 items-center justify-start space-x-2 md:h-10">
                        <div class="flex h-full w-6 shrink-0 items-center justify-center overflow-hidden rounded-full md:w-10">
                            <img class="h-full w-full object-cover" src="https://source.unsplash.com/random/2" />
                        </div>
                ...
                <div class="relative mb-6 rounded-xl space-y-4">
                    <img class="rounded-xl shadow-md" src="https://source.unsplash.com/random/20" />
                    <div class="flex h-6 items-center justify-start space-x-2 md:h-10">
                        <div class="flex h-full w-6 shrink-0 items-center justify-center overflow-hidden rounded-full md:w-10">
                            <img class="h-full w-full object-cover" src="https://source.unsplash.com/random/2" />
                        </div>
